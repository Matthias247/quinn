...
use crate::{
    crypto, crypto::Keys, frame, packet::SpaceId, range_set::CompactRangeSet, shared::IssuedCid,
    Dir, StreamId, VarInt,
};
    ...
    S: crypto::Session,
{
    ...
    pub(crate) pending_acks: CompactRangeSet,
    ...
    S: crypto::Session,
{
    pub(crate) fn new(now: Instant) -> Self {
        Self {
            ...
            pending_acks: CompactRangeSet::new(),
...
pub(crate) struct SentPacket {
    ...
    pub(crate) acks: CompactRangeSet,
